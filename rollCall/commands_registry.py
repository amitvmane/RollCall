...
COMMANDS = [
    ...
    },
    {
        ...
        "details": (
            ...
            "Anyone who has ever collected for this chat can also run /mark_paid "
            "without being a chat admin — that standing doesn't expire when a later "
            "game is closed with a different collector.\n\n"
            "Examples:\n"
            "  /set_collector Ravi\n"
